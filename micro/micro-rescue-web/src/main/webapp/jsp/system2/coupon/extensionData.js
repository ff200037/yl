...
var extensionBtn = UD.lib.createModifyBtn(function(record) {
    	iframeWindow = UD.lib.showIframeWindow(contextPath + "/coupon/coupon/extensionPage?id=" + record.get("id"), 500, 370, "推广")
	}
);
