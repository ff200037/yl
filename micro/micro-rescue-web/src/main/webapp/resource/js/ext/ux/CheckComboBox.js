...
/**
* Ext.ux.form.CheckComboBox, List of Values Combo
* 扩展ComboBox
* @author     fubiyue
* @copyright (c) 2012 Ext JS
* @date      2012-11-12
* @version   $Id: Ext.ux.form.CheckComboBox.js 2012-11-12 09:22:20
*
* @license Ext.ux.form.CheckComboBox.js is licensed under the terms of the Open Source
* LGPL 3.2 license. Commercial use is permitted to the extent that the 
...
/**
*
* @class Ext.ux.form.CheckComboBox
* @extends Ext.form.ComboBox
*/
Ext.ux.form.CheckComboBox = Ext.extend(Ext.form.ComboBox, {
    ...
    ,initComponent:function() {
        ...
        if(!this.tpl) {
            this.tpl = 
                ...
                +'class="ux-checkComboBox-icon ux-checkComboBox-icon-'
                //+'{[values.' + this.checkField + '?"checked":values.' + this.checkField + '===null?"mixed":"unchecked"' + ']}">'
                +'{[values.' + this.checkField + '?"checked":"unchecked"' + ']}">'
                +'<div class="ux-checkComboBox-item-text">{' + (this.displayField || 'text' )+ '}</div>'
                +'</div>'
                +'</tpl>'
            ;
        }
        ...
        // call parent
        Ext.ux.form.CheckComboBox.superclass.initComponent.apply(this, arguments);
     ...
     */
    ,initEvents:function() {
        Ext.ux.form.CheckComboBox.superclass.initEvents.apply(this, arguments);
    ...
    // {{{
    /**
     * Sets the value of the CheckComboBox
     * @param {Mixed} v value
     */
    ,setValue:function(v) {
        if(v) {
...
// register xtype
Ext.reg('checkComboBox', Ext.ux.form.CheckComboBox); 
//backwards compat
Ext.ux.CheckComboBox = Ext.ux.form.CheckComboBox;