 ...
 */
 Ext.ux.ManagedIframePanel = Ext.extend(Ext.Panel, {
    ...
    */
    ...
    bodyCfg:{tag:'div'
      ,cls:'x-panel-body'
      ,children:[{tag:'iframe',frameBorder:0,width:'100%',height:this.defaultHeight||'100%',cls:'x-managed-iframe',scrolling:'auto'}]
    },
    ...
    initComponent : function(){ 
     ...
     setSrc : function(url, discardUrl){
		...
		if(this.rendered && this.iframe){ //rendered?
			  ...
			  this.iframe.dom.height=this.defaultHeight||'100%';//add by mlc 2008-04-15
        }
